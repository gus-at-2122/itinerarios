...
class CarbonFieldsServiceProvider implements ServiceProviderInterface {
	...
	protected function registerPostMeta() {
		...
		Container::make( 'post_meta', __( 'Custom Data', 'my_app' ) )
			->where( 'post_type', '=', 'my_itinerario' )
			->add_fields( array(
				Field::make( 'association', 'iti_pasos', __( 'Association' ) )
					->set_types( array(
						array(
							'type'      => 'post',
							'post_type' => 'my_paso',
		...
		Container::make( 'post_meta', __( 'Custom Data', 'my_app' ) )
			->where( 'post_type', '=', 'my_paso' )
			->add_fields( array(
				Field::make( 'association', 'iti_pildora', __( 'Association' ) )
					->set_types( array(
						array(
							'type'      => 'post',
							'post_type' => 'my_paso',
	...
	protected function registerUserMeta() {
		...
		Container::make( 'user_meta', __( 'Custom Data', 'my_app' ) )
			->add_fields( array(
				Field::make( 'association', 'user_iti', __( 'Association' ) )
					->set_types( array(
						array(
							'type'      => 'post',
							'post_type' => 'my_itinerario',
						)
					) )
			));
